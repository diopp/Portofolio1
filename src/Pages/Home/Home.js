                ...
                <div className="">
                    <div className="home container mx-auto flex flex-col items-center py-12 sm:py-24">
                        <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-left flex-col mr-20  mb-5 sm:mb-10">
                            <p className="name text-white">Hello, I am 
                            
                            
                            </p>
                            <h1 className=" h1 text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl items-left  text-laser-200 font-black leading-7 md:leading-10">
                                Papa Diop.
